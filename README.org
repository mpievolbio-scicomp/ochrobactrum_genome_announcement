...
:END:
The data produced by running =fastANI= on our our assembled genomes contains 12*11=132 pairwise ANI similarities, corresponding
to our 10 assembled genomes and 4 reference type strains. Before analyzing it further, some cleanup steps need to be taken:
